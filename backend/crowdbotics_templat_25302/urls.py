"""crowdbotics_templat_25302 URL Configuration
...
admin.site.site_header = "crowdbotics-template"
admin.site.site_title = "crowdbotics-template Admin Portal"
admin.site.index_title = "crowdbotics-template Admin"

# swagger
api_info = openapi.Info(
    title="crowdbotics-template API",
    default_version="v1",
    description="API documentation for crowdbotics-template App",
)
